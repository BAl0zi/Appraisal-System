...
const APPRAISAL_HIERARCHY: Partial<Record<UserRole, UserRole[]>> = {
  ...
  'SPECIAL NEEDS TEACHER': ['HEAD TEACHER', 'SPECIAL NEEDS COORDINATOR'],
  'LAB TECHNICIAN': ['HEAD TEACHER', 'SPECIAL NEEDS COORDINATOR'],
  'LIBRARIAN': ['HEAD TEACHER', 'SPECIAL NEEDS COORDINATOR'],
  'COACH': ['COCURRICULAR HEAD'],
  ...
  'TEACHERS': ['SECTION HEAD UPPER PRIMARY', 'SECTION HEAD JUNIOR SCHOOL', 'SECTION HEAD LOWER PRIMARY', 'CURRICULUM COORDINATOR', 'SPECIAL NEEDS COORDINATOR'],
