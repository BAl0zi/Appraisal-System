...
import { LayoutDashboard, FileText, Settings, Users, ClipboardList } from 'lucide-react';
...
export default function AppraiserDashboard({ currentUser, initialTab, role }: AppraiserDashboardProps) {
  const [activeTab, setActiveTab] = useState<'home' | 'appraisals' | 'team_performance' | 'assignments' | 'settings'>((initialTab as any) || 'home');
